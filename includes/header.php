...
<body>
    <div class="app-shell">
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                <a class="<?= $currentPath === app_url('/index.php') || $currentPath === app_url('') || $currentPath === '/Land-Invertory-System/index.php' || $currentPath === '/Land-Invertory-System/' ? 'active' : ''; ?>" href="<?= h(app_url('/index.php')); ?>">Dashboard</a>
